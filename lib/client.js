...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function LifecycleCard(props) {
      ...
      const arOk = Number(draft.archiveHours) >= 0 && Number(draft.archiveHours) <= 720;
      const invalid = !minOk || !maxOk || !uiOk || !arOk;
      ...
      const body = h('div', { style: { borderTop: '1px solid ' + V.border, margin: '0 16px', paddingBottom: 8 } },
        ...
        field('archiveHours', '归档保留（小时）', '清理的会话先归档保留 N 小时再删，0 = 立即删除'),
